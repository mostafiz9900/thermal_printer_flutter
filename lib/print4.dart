...
class Print4 extends StatefulWidget {
  final List<Map<String, dynamic>> data;
  Print4(this.data);
  @override
  _Print4State createState() => _Print4State();
}

class _Print4State extends State<Print4> {
  ...
  Future<Ticket> _ticket(PaperSize paper) async {
    ...
    ticket.text(' ألاما',
        styles: PosStyles(align:PosAlign.center,codeTable: PosCodeTable.pc1001_2));
    ticket.feed(1);
